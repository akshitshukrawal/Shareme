...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  return (
    <div className='m-2'>
      ...
      >
        <img className='rounded-full w-full' src={urlFor(image).width(250).url()} alt="user-post" />
        {postHovered && (
            ...
            <div className='flex justify-between items-center gap-2 w-full'>
              ...
              {postedBy?._id === user?.googleId && (
                <button
                  ...
                  className='bg-white p-2 opacity-75 hover:opacity-100 font-bold text-dark text-base rounded-3xl hover:shadow-md outlined-none'
                >
                  <AiTwotoneDelete />
                </button>
              )}
