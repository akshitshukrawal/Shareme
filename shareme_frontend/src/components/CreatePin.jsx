          ...
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    use high-quality JPEG, SVG, PNG less than 20 MB
                  </p>
                </div>
                <input type="file"
                  name='upload-image'
              ...
              <div className='relative h-full '>
                ...
                <button
                type='button'
                className='absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl coursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full '>
          ...
          <div className='flex flex-col'>
            <div>
              ...
              className='outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer' name="" id="">
